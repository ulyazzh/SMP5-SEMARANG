...
<!-- Sidebar -->
        <div class="w-64 bg-blue-700 min-h-screen p-4 text-white">
            ...
            <nav class="space-y-4">
                <a href="profil-sekolah.php" class="block hover:bg-blue-800 p-2 rounded">Profil Sekolah</a>
        ...
        <div class="flex-1 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white shadow rounded p-4">
                    <h2 class="text-xl font-bold mb-2">Ekstrakurikuler</h2>
                    <p class="text-gray-600 mb-4">Kelola kegiatan ekstrakurikuler.</p>
                    <button class="bg-blue-600 text-white px-4 py-2 rounded">Kelola</button>
                </div>
